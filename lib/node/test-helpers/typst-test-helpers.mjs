...
import { createProjectTempDir, ensureProjectTempRoot } from '../tmp-dir.mjs';
...
export function buildTypstHtml({ sourceText, outputName = 'out.html', inputs = [], extraFiles = [], prefix = '.tmp-post-layout-html-' }) {
...
export function compileTypstPdfText(sourceText, { prefix = '.tmp-template-post-pdf-test-', extraFiles = [] } = {}) {
  ...
  const textResult = result.status === 0
