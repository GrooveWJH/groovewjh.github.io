...
test('theme toggle uses Carbon-like bare header actions with underline-only active state', () => {
  ...
  assert.match(themeToggleCss, /-webkit-mask-size:\s*contain;/);
  assert.match(themeToggleCss, /-webkit-mask-repeat:\s*no-repeat;/);
  assert.match(themeToggleCss, /-webkit-mask-position:\s*center;/);
  assert.match(themeToggleCss, /-webkit-mask-image:\s*url\("\/assets\/icons\/sun\.svg"\);/);
  assert.match(themeToggleCss, /-webkit-mask-image:\s*url\("\/assets\/icons\/moon\.svg"\);/);
  assert.match(themeToggleCss, /-webkit-mask-image:\s*url\("\/assets\/icons\/automatic\.svg"\);/);
