import {
  buildExportFileName,
  renderPlatformCardSvg,
  usesSmartPreviewColors,
...
export async function exportPlatformCardToPngBlob(entry, platformKey, {
  pixelRatio = 2,
  squareCanvas = false,
  displayOptions = null,
  ...
  const smartColors = usesSmartPreviewColors(platformKey) && sourceImageUrl
    ? await resolveSmartPreviewColors(sourceImageUrl)
    : null;
  ...
  const { width, height } = svgSizeFromMarkup(svgMarkup);
