/*! qrcode-generator v1.4.4 | vendored for share preview runtime */
var qrcode = (function () {
  function i(t, r) {
    function a(t, r) {
      (g = (function (t) {
    ...
    (s.addData = function (t, r) {
        ...
        if (u < 1) {
          for (var t = 1; t < 40; t++) {
            for (var r = b.getRSBlocks(t, f), e = M(), n = 0; n < c.length; n++) {
              var o = c[n];
              e.put(o.getMode(), 4), e.put(o.getLength(), B.getLengthInBits(o.getMode(), t)), o.write(e);
            }
            var i = 0;
      ...
      (s.createSvgTag = function (t, r, e, n) {
        var o = {};
        'object' == typeof t && ((t = (o = t).cellSize), (r = o.margin), (e = o.alt), (n = o.title)),
          (t = t || 2),
          (r = void 0 === r ? 4 * t : r),
        ...
        var i,
          ...
          u,
          f,
          c = s.getModuleCount() * t + 2 * r,
          g = '';
        for (
          f = 'l' + t + ',0 0,' + t + ' -' + t + ',0 0,-' + t + 'z ',
            g += '<svg version="1.1" xmlns="http://www.w3.org/2000/svg"',
            g += o.scalable ? '' : ' width="' + c + 'px" height="' + c + 'px"',
            g += ' viewBox="0 0 ' + c + ' ' + c + '" ',
            g += ' preserveAspectRatio="xMinYMin meet"',
            g += n.text || e.text ? ' role="img" aria-labelledby="' + p([n.id, e.id].join(' ').trim()) + '"' : '',
            g += '>',
            g += n.text ? '<title id="' + p(n.id) + '">' + p(n.text) + '</title>' : '',
            g += e.text ? '<description id="' + p(e.id) + '">' + p(e.text) + '</description>' : '',
            g += '<rect width="100%" height="100%" fill="white" cx="0" cy="0"/>',
            g += '<path d="',
            a = 0;
          a < s.getModuleCount();
          a += 1
        )
          for (u = a * t + r, i = 0; i < s.getModuleCount(); i += 1)
            s.isDark(a, i) && (g += 'M' + (i * t + r) + ',' + u + f);
        return (g += '" stroke="transparent" fill="black"/>'), (g += '</svg>');
      }),
      (s.createDataURL = function (o, t) {
        (o = o || 2), (t = void 0 === t ? 4 * o : t);
        var r = s.getModuleCount() * o + 2 * t,
          i = t,
          a = r - t;
      ...
      (s.createImgTag = function (t, r, e) {
        (t = t || 2), (r = void 0 === r ? 4 * t : r);
        var n = s.getModuleCount() * t + 2 * r,
          o = '';
        return (
          (o += '<img'),
          (o += ' src="'),
          (o += s.createDataURL(t, r)),
          (o += '"'),
          (o += ' width="'),
          (o += n),
          (o += '"'),
    ...
    return (
      (s.createASCII = function (t, r) {
        if ((t = t || 1) < 2)
          return (function (t) {
            ...
            var r,
              ...
              l = '';
            for (r = 0; r < a; r += 2) {
              for (n = Math.floor((r - u) / 1), o = Math.floor((r + 1 - u) / 1), e = 0; e < a; e += 1)
                (i = '█'),
                  u <= e && e < f && u <= r && r < f && s.isDark(n, Math.floor((e - u) / 1)) && (i = ' '),
                  u <= e && e < f && u <= r + 1 && r + 1 < f && s.isDark(o, Math.floor((e - u) / 1))
                    ? (i += ' ')
                    : (i += '█'),
                  (l += t < 1 && f <= r + 1 ? g[i] : c[i]);
              l += '\n';
            ...
            return a % 2 && 0 < t
              ? l.substring(0, l.length - a - 1) + Array(1 + a).join('▀')
        ...
        var e,
          ...
          h = '';
        for (e = 0; e < a; e += 1) {
          for (o = Math.floor((e - u) / t), h = '', n = 0; n < a; n += 1)
            (i = 1),
              u <= n && n < f && u <= e && e < f && s.isDark(o, Math.floor((n - u) / t)) && (i = 0),
              (h += i ? c : g);
          for (o = 0; o < t; o += 1) l += h + '\n';
        }
        return l.substring(0, l.length - 1);
      }),
      (s.renderTo2dContext = function (t, r) {
        r = r || 2;
        for (var e = s.getModuleCount(), n = 0; n < e; n++)
          for (var o = 0; o < e; o++)
            (t.fillStyle = s.isDark(n, o) ? 'black' : 'white'), t.fillRect(n * r, o * r, r, r);
      }),
      s
    );
  }
    ...
    var r = (function () {
      ...
      i = {
        ...
        mod: function (t) {
          ...
          for (
            var r = w.glog(i.getAt(0)) - w.glog(t.getAt(0)), e = new Array(i.getLength()), n = 0;
            n < i.getLength();
            n += 1
          )
            e[n] = i.getAt(n);
    ...
    b =
      ...
      ((A = {}).getRSBlocks = function (t, r) {
        ...
        for (var n, o, i = e.length / 3, a = [], u = 0; u < i; u += 1)
          for (var f = e[3 * u + 0], c = e[3 * u + 1], g = e[3 * u + 2], l = 0; l < f; l += 1)
            a.push(((n = g), (o = void 0), ((o = {}).totalCount = c), (o.dataCount = n), o));
        return a;
      }),
      A),
    M = function () {
      ...
      for (
        var n = (function (t, r) {
            var n = t,
              ...
              i = function (t) {
                for (var r = 1 << t, e = 1 + (1 << t), n = t + 1, o = h(), i = 0; i < r; i += 1)
                    ...
                    var e = t,
                      ...
                      r = {
                        write: function (t, r) {
                          ...
                          for (; 8 <= n + r; )
                            e.writeByte(255 & ((t << n) | o)), (r -= 8 - n), (t >>>= 8 - n), (n = o = 0);
                          (o |= t << n), (n += r);
                        },
                        flush: function () {
                          0 < n && e.writeByte(o);
                ...
                for (f += 1; f < l.length; ) {
                  var g = String.fromCharCode(l[f]);
                  (f += 1),
                    o.contains(c + g)
                      ? (c += g)
                      : (u.write(o.indexOf(c), n),
                        o.size() < 4095 && (o.size() == 1 << n && (n += 1), o.add(c + g)),
                        (c = g));
                }
