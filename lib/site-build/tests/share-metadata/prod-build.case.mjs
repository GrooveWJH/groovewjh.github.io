...
test('build emits normalized production share metadata for pages and posts', () => {
  ...
  assert.match(preludeHead, /<link rel="preload" href="\/assets\/fonts\/noto-serif-sc-basic-700\.woff2"/);
  assert.match(preludeHead, /<link rel="preload" href="\/assets\/fonts\/noto-serif-sc-non-basic-400\.woff2"/);
  assert.match(preludeHead, /<link rel="preload" href="\/assets\/fonts\/noto-serif-sc-non-basic-700\.woff2"/);
  ...
  assert.ok(
    preludeHead.indexOf('/assets/fonts/site-kai-non-basic-400.woff2') < preludeHead.indexOf('/assets/fonts.css'),
    'Expected release Kai preload to be emitted before fonts.css.',
  );
