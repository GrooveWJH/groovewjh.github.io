...
import { TYPE_TOOLCHAIN_DIR } from '../../foundation/paths.mjs';
...
export function makeTypstCompileArgs(rootDir, sourcePath, outputPath, inputEntries = []) {
  ...
  args.push(normalizePosixPath(relative(rootDir, sourcePath)), normalizePosixPath(relative(rootDir, outputPath)));
