...
<html>
  ...
  assert.equal(entry.panelIntent, 'dark-anchor');
});

test('buildSharePreviewEntry restores multiline descriptionText from managed HTML metadata without post sidecar data', () => {
  const entry = buildSharePreviewEntry({
    outputRel: 'posts/articles/content-desc/index.html',
    html: `<!DOCTYPE html>
<html>
  <head>
    ...
    <meta name="typ-blog:description-text" content="第一行&#10;第二行&#10;第三行">
    <meta property="og:title" content="｢Content Desc｣ · Groove Blog">
    <meta property="og:type" content="article">
    <meta property="og:site_name" content="Groove Blog">
    <meta property="article:published_time" content="2026-04-23">
  ...
  assert.equal(entry.description, '第一行 第二行 第三行');
  assert.equal(entry.descriptionText, '第一行\n第二行\n第三行');
});
