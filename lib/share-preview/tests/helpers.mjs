...
export function createPreludeEntry({
  includeDescription = true,
  includePublishedTime = true,
  description = '那时候，你就会明白，一切我们爱过与恨过的，其实并没有什么不同。',
  descriptionText = undefined,
  ...overrides
} = {}) {
  const descriptionMeta = includeDescription ? `<meta name="description" content="${escapeAttr(description)}">` : '';
