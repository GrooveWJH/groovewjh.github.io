...
import { renderIMessageCard } from './imessage.mjs';
...
export function renderPlatformCardSvg(entry, _platformKey, options = {}) {
  ...
  const svgMarkup = renderIMessageCard(entry, imageHref, {
    ...
    squareCanvas: options.squareCanvas,
    cornerSize: options.cornerSize,
    edgeFeatherEnabled: options.edgeFeatherEnabled,
    edgeFeatherSize: options.edgeFeatherSize,
