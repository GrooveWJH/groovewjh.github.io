...
export function buildSharePreviewEntry({ outputRel, html, outputSiteDir = null, post = null }) {
  ...
  const htmlDescriptionText = extractRawMetaContent(headHtml, 'name', 'typ-blog:description-text');
  const descriptionText = rawDescriptionText || htmlDescriptionText || description || null;
  ...
  const panelIntent = collapseWhitespace(post?.panelIntent || '') || null;
  const entry = {
