...
import { buildTypstHtml, createTempDir, ROOT_DIR } from './typst.mjs';

export { buildTypstHtml, ROOT_DIR };

export function buildSiteTemp({ shareOrigin = 'local', outDirName = null, fontMode = null } = {}) {
  ...
  const fontModeArgs = fontMode ? ['--font-mode', fontMode] : [];
